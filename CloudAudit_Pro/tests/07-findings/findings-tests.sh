...
validate_finding() { check_field "$1" '.id' && check_field "$1" '.title'; }
...
echo ""
echo "━━━ Test 1: List Findings ━━━"
test_endpoint "List Findings" "GET" "/findings" "" "200" "$TOKEN" "validate_list" >/dev/null

echo "" && echo "━━━ Test 2: Unauthorized Access ━━━"
test_endpoint "No Auth" "GET" "/findings" "" "401" "" "" >/dev/null
