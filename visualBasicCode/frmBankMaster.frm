...
Begin VB.Form frmBankMaster 
   ...
   Begin VB.CommandButton fndBankID 
      Height          =   315
      Left            =   6200
      Picture         =   "frmBankMaster.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   330
      Width           =   315
   ...
   Begin VB.Frame frameBank 
      ...
      Begin VB.CommandButton fndStatusID 
         Height          =   315
         Left            =   2655
         Picture         =   "frmBankMaster.frx":018A
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   855
         Width           =   315
   ...
   Begin MSComctlLib.ImageList imglstCtrls 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":0314
            Key             =   "New"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":046E
            Key             =   "Open"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":05C8
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":0722
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":08FC
            Key             =   "Save"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":0A56
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":0C30
            Key             =   "Notes"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":0D8A
            Key             =   "Status"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":228C
            Key             =   "Close"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":2466
            Key             =   "Copy"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":2640
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBankMaster.frx":281A
            Key             =   "Notepad"
            Object.Tag             =   "N"
         EndProperty
      EndProperty
...
Public Property Let EnableAll(ByVal blnNewValue As Boolean)
    frameBank.Enabled = blnNewValue
    fndBankID.Enabled = Not blnNewValue
End Property
...
Dim strRslt As String
    If lngID = 0 Then
        strRslt = PrepareAndFind(cnstSearchTypeGrpBank, "Where StatusID = " & cnstStatusActive, "XBankID", , fndBankID)
        If strRslt <> "-1" Then
            mlngId = Val(strRslt)
            txtBankName.Tag = mlngId
        End If
    Else
        strRslt = lngID
        mlngId = lngID
...
Dim sSql As String, rsValues As New Recordset
    sSql = "SELECT BM.BankID AS BankID, BM.BankName AS BankName, BM.StatusID AS StatusID, ST.StatusName AS Status " & _
           "FROM   BankMaster BM INNER JOIN Status ST ON BM.StatusID = ST.StatusID Where BM.BankID = " & lngID
    Set rsValues = GetRecords(sSql)
    With rsValues
        txtBankName.Tag = lngID
        txtBankName.Text = .Fields("BankName") & ""
...
Dim IsInTran As Boolean, sSql As String, rsSave As New Recordset, lngBankID As Long, blnIsNew As Boolean
    
    If Trim(txtBankName) = "" Then
        pMVE.MsgBox "Bank name not mentioned", msgOK, "AuditMate", msgInformation, True
        Save = False
        Exit Function
    End If
    '------------------------------------------------
    sSql = "Select * From BankMaster Where BankID = " & Val(txtBankName.Tag)
    AdoConn.BeginTrans
    IsInTran = True
    ...
    With rsSave
        If .EOF Then
            .AddNew
            lngBankID = GetMaxNo("BankMaster", "BankID")
            lngID = lngBankID
            .Fields("BankID") = lngBankID
        End If
...
Dim IsInTran As Boolean, sSql As String
    ...
    AdoConn.BeginTrans
    IsInTran = True
    sSql = "Delete From BankMaster Where BankID = " & Val(txtBankName.Tag)
