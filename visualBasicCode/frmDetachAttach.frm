...
Begin VB.Form frmDetachAttach 
   ...
   Begin VB.CheckBox chkDocTransfer 
      Caption         =   "Transfer external documents"
      Height          =   255
      Left            =   120
      TabIndex        =   10
      Top             =   1920
   ...
   End
End
Attribute VB_Name = "frmDetachAttach"
...
Dim blnSuccess As Boolean
    ...
    Else
        ...
        Set mcnnTo = AdoConn
    End If
    If OpenConn(mcnnClient, pServerLocal, pInitialCatelogLocal, "sa", "") _
        And OpenConn(mcnnFromDoc, mstrServerFrom, pInitialCatelogDoc, "sa", "") _
        And OpenConn(mcnnToDoc, mstrServerTo, pInitialCatelogDoc, "sa", "") _
        And OpenConn(mcnnToBak, mstrServerFrom, pInitialCatelogMainBak, "sa", "") _
        And OpenConn(mcnnToDocBak, mstrServerFrom, pInitialCatelogDocBak, "sa", "") Then
